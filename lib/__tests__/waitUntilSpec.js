...
describe('waitUntilSpec', () => {
  ...
  it('should invoke the callback as often as specified in the delay', async done => {
    expect(page.wrapper.html()).toEqual('<h1></h1>')
    return page.waitUntil(() => page.wrapper.html() === '<h1>hello</h1>', { delay: 80 })
  ...
  it('should invoke the callback at most 50 times by default', async done => {
    return page.waitUntil(() => false, { delay: 1 })
      .catch(error => {
  ...
  it('should invoke the callback every 10 ms by default', async done => {
    return page.waitUntil(() => false, { numberOfTries: 1 })
      .catch(error => {
  ...
  it('should invoke the callback at most as many times as specified by numberOfTries', async done => {
    return page.waitUntil(() => false, { delay: 1, numberOfTries: 1 })
      .catch(error => {
